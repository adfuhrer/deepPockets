...
# second try
classifier = tf.contrib.learn.DNNClassifier(feature_columns=feature_columns,hidden_units=[50, 50], n_classes=2)
# our first approach
#classifier = tf.contrib.learn.DNNClassifier(hidden_units=[30, 50, 10], n_classes=2)
print('training finished')

# Fit model.
classifier.fit(x=x_train, y=y_train ,steps=10000)
# Evaluate accuracy.
